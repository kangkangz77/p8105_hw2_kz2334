...
*   Maximum and minimum weight of dumpsters is `r round(max(trash_data$weight), 2)` tons and `r round(min(trash_data$weight),2)` tons respectively.
...
*   Maximum and minimum monthly precipitation in 2016 and 2017 is `r round(max(prcp_data$total), 2)` tons and `r round(min(prcp_data$total),2)` tons respectively.